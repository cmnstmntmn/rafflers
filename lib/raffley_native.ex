defmodule RaffleyNative do
  ...
  import RaffleyWeb, only: [verified_routes: 0]
  ...
  def live_view() do
    quote do
      use LiveViewNative.LiveView,
        ...
        layouts: [
          swiftui: {RaffleyWeb.Layouts.SwiftUI, :app}
        ],
  ...
  defp helpers(format) do
    ...
    core_component_module = Module.concat([RaffleyWeb, CoreComponents, plugin.module_suffix])
